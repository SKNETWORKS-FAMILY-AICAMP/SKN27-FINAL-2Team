...
urlpatterns = [
    ...
    path("api/wrong-note/recommendation/", views.wrong_note_recommendation, name="api_wrong_note_recommendation"),
    path("api/wrong-note/start/", views.wrong_note_start, name="api_wrong_note_start"),
