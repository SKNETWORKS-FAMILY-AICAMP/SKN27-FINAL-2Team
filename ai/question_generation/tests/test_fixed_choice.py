...
from ai.question_generation.evaluation.fixed_choice import normalize_gate
from ai.question_generation.evaluation.v18 import build_messages, records_from_assembled
from ai.question_generation.generation.assemble import assemble_question
from ai.question_generation.workflows.closed_pack_batch import evaluation_accepted
from ai.question_generation.workflows.question_pipeline import CallBudget, generate_v41_question_stage, new_state
...
class FixedChoiceTest(unittest.TestCase):
    def make_question(self, mode: str) -> dict:
        ...
        with patch("ai.question_generation.workflows.question_pipeline.call_sllm") as sllm, patch(
