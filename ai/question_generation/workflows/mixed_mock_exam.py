...
from ai.question_generation.postprocess_questions import load_questions
from ai.question_generation.workflows.closed_pack_batch import load_image_packs, render_markdown


PROJECT_ROOT = Path(__file__).resolve().parents[3]
DATA_ROOT = PROJECT_ROOT / "ai" / "question_generation" / "data" / "production_20260723"
DEFAULT_QUESTIONS = [
