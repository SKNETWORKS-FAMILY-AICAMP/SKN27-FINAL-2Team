...
# v10 선지 단위 이진 분류 학습 노트북 생성기입니다.
OUT = Path(__file__).resolve().parent / "train_choice_quality_runpod_v10.ipynb"
...
v10은 문항 전체 사용불가 여부가 아니라 **선지 자체의 오류 유무**만 학습합니다.  
...
```text
/workspace/
├─ train_choice_quality_runpod_v10.ipynb
└─ common/
...
OUTPUT_DIR = WORKSPACE_DIR / "choice_quality_output_v10"
