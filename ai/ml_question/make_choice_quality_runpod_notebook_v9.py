...
# v9 선지 단위 이진 분류 학습 노트북 생성기입니다.
OUT = Path(__file__).resolve().parent / "train_choice_quality_runpod_v9.ipynb"
...
v9은 문항 전체 사용불가 여부가 아니라 **선지 자체의 오류 유무**만 학습합니다.  
...
TRAIN_JSON = DATA_DIR / "choice_quality_train_v9.json"
TEST_JSON = DATA_DIR / "choice_quality_test_v9.json"
OUTPUT_DIR = WORKSPACE_DIR / "choice_quality_output_v9"
