# ML Fixed Holdout + Walk-Forward 평가 정리 - 2026-07-16
...
| 평가 방식 | target | Accuracy | Macro F1 | Weighted F1 |
| --- | --- | ---: | ---: | ---: |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fixed_holdout | era_topic_train | 0.7400 | 0.7008 | 0.7341 | 41 | 40 | 400 |
| fixed_holdout | era_topic_train_topic | 0.6825 | 0.3620 | 0.6868 | 64 | 77 | 400 |
| walk_forward | era_topic_train | 0.7575 | 0.6956 | 0.7512 | 41 | 40 | 400 |
| walk_forward | era_topic_train_topic | 0.6900 | 0.3835 | 0.6985 | 64 | 80 | 400 |

## Walk-Forward 회차별 조합 성능: era + topic_train

| round_no | accuracy | macro_f1 | weighted_f1 | label_count_true | label_count_pred | test_size |
| --- | --- | --- | --- | --- | --- | --- |
| 71 | 0.7400 | 0.6460 | 0.7273 | 28 | 26 | 50 |
| 72 | 0.7400 | 0.5426 | 0.7307 | 26 | 27 | 50 |
| 73 | 0.6600 | 0.5255 | 0.6549 | 27 | 26 | 50 |
| 74 | 0.7800 | 0.6835 | 0.7524 | 29 | 26 | 50 |
| 75 | 0.7600 | 0.7204 | 0.7806 | 26 | 28 | 50 |
| 76 | 0.7400 | 0.7288 | 0.7284 | 27 | 26 | 50 |
| 77 | 0.7800 | 0.7310 | 0.7764 | 30 | 29 | 50 |
| 78 | 0.8600 | 0.8648 | 0.8597 | 29 | 29 | 50 |
