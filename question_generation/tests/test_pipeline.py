...
from question_generation.core.exam_distribution import apportion
from question_generation.retrieval.closed_pack_bank import build_reviewed_packs, read_frames
from question_generation.retrieval.closed_pack_input import build_generation_pack, plan_variants, select_closed_pack
from question_generation.core.contracts import generation_item, validate_pack
from question_generation.evaluation.v18 import build_messages, evaluation_few_shot_messages, normalize_gate, pending_records, post_chat, records_from_assembled
from question_generation.generation.assemble import assemble_question, validate_question
from question_generation.generation.material import generate_material, material_few_shot_messages
...
from question_generation.generation.sllm_inputs import clean_basis_text, correct_record, distractor_record
from question_generation.generation.sllm_transport import clean_model_text
from question_generation.workflows.question_pipeline import (
    CallBudget,
    PipelineLimitError,
    call_choice_model,
    call_sllm,
...
from question_generation.workflows.closed_pack_batch import (
...
from question_generation.workflows.source_repair import apply_override
...
class QuestionBankPipelineTest(unittest.TestCase):
    ...
    @patch("question_generation.workflows.closed_pack_batch.subprocess.run")
    ...
    @patch("question_generation.evaluation.v18.OpenAI")
    ...
    def test_material_few_shot_prefers_same_route_and_difficulty(self) -> None:
        ...
        with patch(
            "question_generation.generation.material.chat_json",
        ...
        rules = load_json_dict(Path("question_generation/material_type_prompt_rules.json"))
    ...
    def test_image_choice_material_does_not_forbid_its_visual_clue(self) -> None:
        ...
        with (
            patch.dict("question_generation.workflows.question_pipeline.os.environ", {"OPENAI_API_KEY": "unused"}),
            patch(
                "question_generation.workflows.question_pipeline.generate_material",
    ...
    @patch("question_generation.workflows.question_pipeline.call_chat")
    ...
    @patch("question_generation.workflows.question_pipeline.call_sllm")
    ...
    @patch("question_generation.workflows.question_pipeline.chat_json")
    ...
    def test_current_workflows_do_not_import_legacy_paths(self) -> None:
        ...
        for path in (root / "workflows").glob("*.py"):
            ...
            self.assertNotIn("question_generation.legacy", text)
            self.assertNotIn("question_generation.graph_path", text)
    ...
    def test_choice_model_uses_llm_after_two_evaluation_regenerations(self) -> None:
        ...
        ) as chat, patch("question_generation.workflows.question_pipeline.call_sllm") as sllm:
    ...
    def test_choice_model_falls_back_to_llm_after_bounded_sllm_transport_failure(self) -> None:
        ...
        with patch.dict("os.environ", {"OPENAI_API_KEY": "test"}), patch(
            "question_generation.workflows.question_pipeline.call_sllm",
