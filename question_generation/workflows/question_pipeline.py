...
from question_generation.generation.material import chat_json, generate_material
...
from question_generation.generation.sllm_inputs import correct_record, distractor_record
from question_generation.generation.sllm_transport import DEFAULT_MODEL as DEFAULT_RUNPOD_MODEL, call_chat, clean_model_text
from question_generation.core.contracts import (
    generation_item,
    validate_pack,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if "members" in source_pack or "packs" in source_pack:
            from question_generation.retrieval.closed_pack_input import build_generation_pack, select_closed_pack
