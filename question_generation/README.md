...
```powershell
.\.venv\Scripts\python.exe -m question_generation `
...
```powershell
.\.venv\Scripts\python.exe -m question_generation.evaluation.v18 `
  --input <question.json> `
...
```powershell
.\.venv\Scripts\python.exe -m question_generation.workflows.closed_pack_batch `
  --pack-input <closed-pack-collection.json> `
...
```powershell
.\.venv\Scripts\python.exe -m question_generation.workflows.source_repair `
...
```powershell
.\.venv\Scripts\python.exe -m unittest discover -s question_generation\tests -p "test_*.py"
```
