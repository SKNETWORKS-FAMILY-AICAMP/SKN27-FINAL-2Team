...
from question_generation.evaluation.fixed_choice import build_messages as build_fixed_messages
from question_generation.evaluation.fixed_choice import normalize_gate as normalize_fixed_gate


PROJECT_ROOT = Path(__file__).resolve().parents[2]
DEFAULT_RUBRIC = PROJECT_ROOT / "docs" / "hanneung_sllm_eval_rubric_v1_8.md"
DEFAULT_FEW_SHOT = PROJECT_ROOT / "question_generation" / "evaluation" / "v18_few_shot_examples.json"
DEFAULT_OUT_DIR = PROJECT_ROOT / "question_generation" / "outputs"
