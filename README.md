...
```text
[진단평가] → [취약 영역 분석] → [맞춤 문제풀이] → [오답 분석·복습]
                                      ↓
                               [학습 계획]
                                      ↓
                         [근거 기반 AI 챗봇 질의응답]

※ 출제 경향 분석 결과는 문제 생성 시 반영됩니다.
```
---
...
| 출제 경향 분석 | 회차별 기출 통계와 ML 모델을 활용해 출제 경향을 분석합니다. | Python, ML |
...
| 출제 경향 분석 | 회차별 기출 통계와 ML 모델로 분석한 출제 경향을 문제 생성 조건에 반영합니다. | Python, ML |
---
